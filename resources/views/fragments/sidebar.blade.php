            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item d-flex flex-column justify-content-center">
                    ...
                    <ul class="collapse menu-item flex-column justify-content-center" id="menu-item-collapse-1" 
                        ...
                        <li class="menu-link menu-item-sub align-items-center" 
                            ...
                            <a href="{{ route('film') }}">
                                <span class="menu-text">Xem tất cả</span>
                            </a>
                        </li>
                ...
                <li class="menu-item d-flex flex-column justify-content-center">
                    ...
                    <ul class="collapse menu-item flex-column justify-content-center" id="menu-item-collapse-2" th:classappend="${key =='category' ? 'show' : ''}">
                        <li class="menu-link menu-item-sub align-items-center" th:classappend="${subkey =='category_all' ? 'menu-active' : ''}">
                ...
                <li class="menu-item d-flex flex-column justify-content-center">
                    <a data-toggle="collapse" href="#menu-item-collapse-5"
                       ...
                       th:attr="aria-expanded=${key == 'order' ? true : false}"
                       class="menu-link menu-toggle align-items-center"
                       aria-expanded="false"
                    ...
                    <ul class="collapse menu-item flex-column justify-content-center"  id="menu-item-collapse-5" th:classappend="${key =='order' ? 'show' : ''}">
                        <li class="menu-link menu-item-sub align-items-center" th:classappend="${subkey =='order_all' ? 'menu-active' : ''}">
                            <a href="/admin/order">
                                <span class="menu-text">Xem tất cả</span>
                            </a>
                        </li>
                ...
                <li class="menu-item d-flex flex-column justify-content-center">
                    <a data-toggle="collapse" href="#menu-item-collapse-6"
                       ...
                       th:attr="aria-expanded=${key == 'poster' ? true : false}"
                       class="menu-link menu-toggle align-items-center"
                       aria-expanded="false"
                       aria-controls="menu-item-collapse-6"
                       role="button"
                    >
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <ul class="collapse menu-item flex-column justify-content-center"  id="menu-item-collapse-6" th:classappend="${key =='poster' ? 'show' : ''}">
                        <li class="menu-link menu-item-sub align-items-center" th:classappend="${subkey =='poster_all' ? 'menu-active' : ''}">
                            <a href="/admin/poster">
                                <span class="menu-text">Xem tất cả</span>
                            </a>
                        </li>
                        <li class="menu-link menu-item-sub align-items-center" th:classappend="${subkey =='poster_new' ? 'menu-active' : ''}">
                            <a href="/admin/poster/add">
                                <span class="menu-text">Thêm mới</span>
                            </a>
                        </li>
                    </ul>
