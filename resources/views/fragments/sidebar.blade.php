    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="aside-menu mb-1" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            <ul class="menu-nav">
                ...
                <li class="menu-item d-flex flex-column justify-content-center">
                    <a   data-toggle="collapse"
                         href="#menu-item-collapse-6"
                         {{ $key == 'booking' ? 'menu-active' : '' }}
                         aria-expanded="{{ $key == 'booking' ? 'true' : 'false' }}"
                         class="menu-link menu-toggle align-items-center"
                         role="button"
                         aria-expanded="false"
                    ...
                    <ul class="collapse menu-item flex-column justify-content-center" id="menu-item-collapse-6" @class(['show' => $key == 'booking'])>
                      
                        <li class="menu-link menu-item-sub align-items-center" 
                            @class(['menu-active' => $subkey == 'booking_all'])>
