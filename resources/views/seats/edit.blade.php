            ...
            <div class="card-body">
                <form action="{{ route('seats.update', $seat->id) }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('seat_number') is-invalid @enderror" id="seat_number" name="seat_number" value="{{ old('seat_number', $seat->seat_number) }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <select class="form-control @error('seat_status') is-invalid @enderror" id="seat_status" name="seat_status">
                                <option value="0" {{ old('seat_status', $seat->seat_status) == 0 ? 'selected' : '' }}>Available</option>
                                <option value="1" {{ old('seat_status', $seat->seat_status) == 1 ? 'selected' : '' }}>Occupied</option>
                            </select>
