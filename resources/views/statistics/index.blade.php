                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h3>${{ number_format($totalAmountPerWeek, 2) }}</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header">Pending Payments (This Week)</div>
                                <div class="card-body">
                                    <h3>{{ $pendingPaymentsPerWeek }}</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header">Seats Booked (This Week)</div>
                                <div class="card-body">
                                    <h3>{{ $seatsBookedPerWeek }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
